...
class TeseCreditoCreateView(PermissionRequiredMixin, CreateView):
    ...
    template_name = 'correcao/tipo_documento_form.html'
    success_url = reverse_lazy('correcao:tipo_documento_list')
...
class TeseCreditoDeleteView(PermissionRequiredMixin, DeleteView):
    model = TeseCredito
    template_name = 'correcao/tipo_documento_confirm_delete.html'
    success_url = reverse_lazy('correcao:tipo_documento_list')
...
@login_required
@require_GET
def tipo_documento_history_json(request, pk):
...
from .serializers import TeseCreditoSerializer
